...
<html lang="pt-BR">
  <head>
    ...
    <title>Loop Contagem regressiva</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  </head>
  <body>
    <h4>8 - Loop Contagem regresiva</h4>
    <p>Do número informado até o 1.</p>
    <form method="post" action="8_resposta.php"> <!-- action vai para outra página -->
            <div class="col-3">
            <div class="mb-3">
